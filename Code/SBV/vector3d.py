...
"""
The code defines a Vector3d class, designed to represent and manipulate 3-dimensional vectors, specifically for use with inertial measurement unit (IMU) sensors.
This class facilitates the handling of 3D spatial data, converting raw sensor readings into more meaningful vehicle-relative coordinates and providing
utility functions for calibration and vector manipulation.
"""
